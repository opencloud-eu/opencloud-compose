...
if [ "${TRAEFIK_LETSENCRYPT_ENABLE}" = "true" ]; then
...
if [ "${TRAEFIK_USE_LOCAL_CERTIFICATES}" = "true" ]; then
...
if [ "${TRAEFIK_LETSENCRYPT_ENABLE}" != "true" ] && [ "${TRAEFIK_USE_LOCAL_CERTIFICATES}" != "true" ]; then
